...
class TestUserPageService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.app.config['MONGO_URI'] = 'mongodb://localhost:27017/test_women_clothing_shop'
        ...
        self.send_reset_email_patcher = patch('app.application.services.user_page_service.send_reset_email')
        self.generate_serializer_patcher = patch('app.application.services.user_page_service.generate_serializer')
        self.hash_password_patcher = patch('app.application.services.user_page_service.user_service.hash_password')
        ...
        self.send_reset_email = self.send_reset_email_patcher.start()
        self.generate_serializer = self.generate_serializer_patcher.start()
        self.hash_password = self.hash_password_patcher.start()
        ...
        self.addCleanup(self.send_reset_email_patcher.stop)
        self.addCleanup(self.generate_serializer_patcher.stop)
        self.addCleanup(self.hash_password_patcher.stop)
    ...
    def test_login_user_success(self):
        ...
        with self.app.test_request_context():
            ...
            self.assertEqual(session.get('user_id'), 'someid')
    ...
    def test_login_user_wrong_password(self):
        ...
        self.mock_user_service.check_password.return_value = False
    ...
    def test_change_user_password_success(self):
        """Тестує успішну зміну пароля користувача."""
        repo = self.mock_user_repo.return_value
        user_mock = MagicMock()
        ...
        self.mock_user_service.check_password.return_value = True
        self.mock_user_service.hash_password.return_value = 'newhash'
